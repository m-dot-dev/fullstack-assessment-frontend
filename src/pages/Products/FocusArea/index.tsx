  ...
  return (
    <div className="relative h-full min-h-40">
      <div className="absolute w-full z-10 flex flex-col text-center items-center h-full justify-center -mt-4">
        <h1 className="font-[Montserrat] sm:text-[30px] lg:text-[58px]  text-[white] pb-0 mb-0 uppercase">
          Solutions that Inspire,
        </h1>
        <h1 className="font-[Montserrat] sm:text-[30px] lg:text-[58px] text-[white] pt-0 -mt-4 uppercase mb-20">
          Products that Deliver
        </h1>
        <p className="font-[Lato] text-[15px] text-[white] max-w-[1000px]">
