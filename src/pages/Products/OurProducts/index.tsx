...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <Card className="w-[30%] min-w-[372px] p-6 m-3 rounded-none shadow-none hover:border-[#942D3B] hover:border hover:border-dashed bg-[#FAF4F3]">
      <CardContent>
          ...
          <div className="flex">
            {Array.from({ length: 5 }, (_, index) => (
              <Star
                ...
                fill={index + 1 <= hoveredStar ? "#F5A623" : "#E3EBF3"}
